      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <NavLink to="/batches" className={navLinkStyle}>Batches</NavLink>
            <NavLink to="/routine" className={navLinkStyle}>Routine</NavLink>
        ...
        {menuOpen && (
          <div className="md:hidden flex flex-col items-end space-y-3 mt-2 pr-2 pb-4">
            ...
            <NavLink to="/batches" className={navLinkStyle} onClick={() => setMenuOpen(false)}>Batches</NavLink>
            <NavLink to="/routine" className={navLinkStyle} onClick={() => setMenuOpen(false)}>Routine</NavLink>
            <NavLink to="/events" className={navLinkStyle} onClick={() => setMenuOpen(false)}>Events</NavLink>
            <NavLink to="/news" className={navLinkStyle} onClick={() => setMenuOpen(false)}>News</NavLink>
          </div>
        )}
      </div>
    </nav>
